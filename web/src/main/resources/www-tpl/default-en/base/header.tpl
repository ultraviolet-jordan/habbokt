...
<div id="header-container">
    <div id="header" class="clearfix">
        ...
        <div id="subnavi">
            ...
            <div id="subnavi-login">
                ...
                <div id="subnavi-login-help" class="clearfix">
                    <ul>
                        <li class="register"><a href="{{ site.sitePath }}/account/password/forgot" id="forgot-password"><span>I forgot my password/username</span></a>
                        </li>
        ...
        <div id="habbos-online">
            <div class="rounded"><span>{{ site.formattedUsersOnline }} {{ site.siteName }}s online</span></div>
        </div>
    </div>
</div>
