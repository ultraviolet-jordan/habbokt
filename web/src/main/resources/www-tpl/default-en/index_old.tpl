                    ...
                    <div class="habblet-container " id="create-habbo">
                        ...
                        <div id="create-habbo" class="layout-static">
                            <div id="create-habbo-nonflash"
                                 style="background-image: url({{ site.staticContentPath }}/web-gallery/v2/images/landing/custom/{{ randomValentinesImage }})">
                                ...
                                <div class="landing-text-3" style="left:170px"><span>...and make new friends :)</span>
                                </div>
                                {% else %}
                                ...
                                <div id="landing-promotional-text"><span>Habbo is a virtual world where you can meet and find your true love.</span>
                                </div>
                            </div>
                        </div>
                        {% else %}
                        <div id="create-habbo" class="layout-static">
                            <div id="create-habbo-nonflash"
                                 style="background-image: url({{ site.staticContentPath }}/web-gallery/v2/images/landing/pixel.gif)">
                ...
                <div class="habblet-container ">
                    ...
                    <div id="remember-me-notification" class="bottom-bubble" style="display:none;">
                        ...
                        <div class="bottom-bubble-c">
                            By selecting 'remember me' you will stay signed in on this computer until you click 'Sign
                            Out'. If this is a public computer please do not use this feature.
                        </div>
