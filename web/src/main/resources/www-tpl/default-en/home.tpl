            ...
            <form action="#" onsubmit="return false;">
                ...
                <div id="edit-menu-gb-availability">
                    <select id="guestbook-privacy-options">
                        <option value="private"{% if (editMode == true) and (guestbookSetting == "private") %}
                                selected{% endif %}>Friends only
                        </option>
                        <option value="public"{% if (editMode == true) and (guestbookSetting == "public") %}
                                selected{% endif %}>Public
                        </option>
                    </select>
                </div>
