                            ...
                            <form action="#" onsubmit="return false;">
                                <div id="edit-menu-skins">
                                    <select id="edit-menu-skins-select">
                                        ...
                                        <option value="2" id="edit-menu-skins-select-speechbubbleskin">Speech Bubble
                                        </option>
                                ...
                                <div id="edit-menu-gb-availability">
                                    <select id="guestbook-privacy-options">
                                        <option value="private"{% if guestbookSetting == "private" %}
                                                selected{% endif %}>Members only
                                        </option>
                                        <option value="public"{% if guestbookSetting == "public" %} selected{% endif %}>
                                            Public
                                        </option>
                                    </select>
                                </div>
