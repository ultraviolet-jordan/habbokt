                ...
                <div class="habblet-container ">
                    <div class="cbb clearfix lightbrown ">
                        ...
                        <div id="habboclub-info" class="box-content">
                            ...
                            <p class="content habboclub-clothing">Show off your new status with a variety of extra clothes and accessories, along with special hairstyles and colors.
                                <br/><br/><a href="{{ site.sitePath }}/credits/club/tryout">Try out {{ site.siteName }} Club clothes for yourself!</a>
            ...
            <div id="column2" class="column">
                ...
                <div class="habblet-container ">
                    <div class="cbb clearfix lightbrown ">
                        ...
                        <h2 class="title">Monthly Gifts </h2>
                        <script src="{{ site.staticContentPath }}/web-gallery/static/js/habboclub.js" type="text/javascript"></script>
