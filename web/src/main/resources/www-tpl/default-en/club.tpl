                ...
                <div class="habblet-container ">
                    <div class="cbb clearfix lightbrown ">
                        ...
                        <div id="habboclub-info" class="box-content">
                            ...
                            <p class="content habboclub-clothing">Show off your new status with a variety of extra
                                clothes and accessories, along with special hairstyles and colors. <br/><br/><a
                                        href="{{ site.sitePath }}/credits/club/tryout">Try out {{ site.siteName }} Club
                                    clothes for yourself!</a>

                            </p>
                            <h3 class="heading">2. Free Furni</h3>
                            <p class="content habboclub-furni">Once a month, every month, you'll get an exclusive piece
                                of {{ site.siteName }} Club furni.</p>
                            <p class="content">Important note: club time is cumulative. This means that if you have a
                                break in membership, and then rejoin, you'll start back in the same place you left
                                off.</p>
                            <h3 class="heading">3. Exclusive Room Layouts</h3>
                            <p class="content">Special Guest Room layouts, only for {{ site.siteName }} Club members.
                                Perfect for showing off your new furni!</p>
                            <p class="habboclub-room"/>

                            <h3 class="heading">4. Access All Areas</h3>
                            <p class="content">Jump the annoying queues when rooms are loading. And that's not all -
                                you'll also get access to HC-only Public Rooms.</p>
                            <h3 class="heading">5. Homepage Upgrades</h3>
                            <p class="content">Join {{ site.siteName }} Club and say goodbye to homepage ads! And this
                                means you can make the most of the HC skins and backgrounds too.</p>
                            <h3 class="heading">6. More Friends</h3>
                            <p class="content habboclub-communicator">600 people! Now that's a lot of buddies however
                                you look at it. More than you can poke with a medium-sized stick, or a big-sized small
                                stick.</p>

                            <h3 class="heading">7. Special Commands</h3>
                            <p class="content habboclub-commands right">Use the :chooser command to see a clickable list
                                of all the users in the room. Pretty handy when you want to sit next to your mate, or
                                kick out a troublemaker.</p>
                            <br/>
                            <p>Use the :furni command to list all the items in a room. Everything is listed, even those
                                sneakily hidden items.</p>
                        </div>
