                        ...
                        <tr>
                            ...
                            <td>
                                <div class="room_info">
                                    ...
                                    <a href="{{ site.sitePath }}/client?forwardId=2&amp;roomId={{ room.getId() }}" target="client" id="room-navigation-link_{{ room.getId() }}" onclick="HabboClient.roomForward(this, '{{ room.getId() }}', 'private', false); return false;"> enter room </a>
                                </div>
                                <br class="clear"/>
