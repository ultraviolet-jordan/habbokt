...
<div class="movable widget RoomsWidget" id="widget-{{ sticker.getId() }}"
        ...
        <div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    {% endif %}
                    <span class="header-left">&nbsp;</span><span class="header-middle">MY ROOMS</span><span
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <div class="room_image">
                                    <img src="{{ site.staticContentPath }}/web-gallery/images/myhabbo/rooms/{{ openState }}.gif"
                                         alt="" align="middle"/>
                                </div>
                            </td>
                            <td>
                                <div class="room_info">
                                    <div class="room_name">
                                        {% autoescape 'html' %}{{ room.getData().getName() }
                                        }{% endautoescape %}            </div>
                                    <div class="clear"></div>
                                    <div>{% autoescape 'html' %}{{ room.getData().getDescription() }
                                        }{% endautoescape %}                </div>
                                    <a href="{{ site.sitePath }}/client?forwardId=2&amp;roomId={{ room.getId() }}"
                                       target="client"
                                       id="room-navigation-link_{{ room.getId() }}"
                                       onclick="HabboClient.roomForward(this, '{{ room.getId() }}', 'private', false); return false;">
                                        enter room </a></div>
                                <br class="clear"/>
