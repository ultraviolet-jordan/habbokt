...
<div class="movable widget MemberWidget" id="widget-{{ sticker.getId() }}"
        ...
        <div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    {% endif %}
                    <span class="header-left">&nbsp;</span><span class="header-middle">Members of this group (<span
                                id="avatar-list-size">{{ members }}</span>)</span><span
