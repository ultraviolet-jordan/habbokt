<div class="movable widget GroupInfoWidget" id="widget-{{ sticker.getId() }}"
        ...
        <div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    <span class="header-left">&nbsp;</span><span class="header-middle">Group info</span><span
        ...
        <div class="widget-body">
            <div class="widget-content">
                ...
                <div class="group-info-icon"><img
                            src="{{ site.habboImagingPath }}/habbo-imaging/badge/{{ group.getBadge() }}.gif"/></div>
                ...
                {% if group.getRoomId() > 0 %}<p><a
                            href="{{ site.sitePath }}/client?forwardId=2&amp;roomId={{ room.getId() }}"
                            onclick="HabboClient.roomForward(this, '{{ room.getId() }}', 'private'); return false;"
                            target="client" class="group-info-room">{% autoescape 'html' %}{{ room.getData().getName() }
                            ...
                            <div class="content-red">
                                <div class="content-red-body">
                                    <span id="tag-limit-message"><img
                                                src="{{ site.staticContentPath }}/web-gallery/images/register/icon_error.gif"/> The limit is 20 tags!</span>
