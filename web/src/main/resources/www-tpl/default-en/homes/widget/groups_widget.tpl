...
<div class="movable widget GroupsWidget" id="widget-{{ sticker.getId() }}"
        ...
        <div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    {% endif %}
                    <span class="header-left">&nbsp;</span><span class="header-middle">My Groups ({{ groupsList|length }})</span><span
                ...
                <div class="groups-list-container">
                    <ul class="groups-list">
                        ...
                        <li title="{{ group.getName() }}" id="groups-list-{{ sticker.getId() }}-{{ group.getId() }}">
                            <div class="groups-list-icon"><a href="{{ group.generateClickLink() }}"><img
                            ...
                            <p>
                                ...
                                <img src="{{ site.staticContentPath }}/web-gallery/images/groups/favourite_group_icon.gif"
                                     width="15" height="15" class="groups-list-icon" alt="Favorite" title="Favorite"/>
                                {% endif %}
                                {% if member.getMemberRank().getRankId() == 3 %}
                                <img src="{{ site.staticContentPath }}/web-gallery/images/groups/owner_icon.gif"
                                     width="15" height="15" class="groups-list-icon" alt="Owner" title="Owner"/>
                                {% endif %}
                                {% if member.getMemberRank().getRankId() == 2 %}
                                <img src="{{ site.staticContentPath }}/web-gallery/images/groups/administrator_icon.gif"
                                     width="15" height="15" class="groups-list-icon" alt="Admin" title="Admin"/>
                                {% endif %}
                            </p>
                            <div class="clear"></div>
                            {% endautoescape %}
