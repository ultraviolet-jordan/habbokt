...
<div class="movable widget GuestbookWidget" id="widget-{{ sticker.getId() }}"
        ...
        <div class="widget-corner" id="widget-{{ sticker.getId() }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    <span class="header-left">&nbsp;</span><span class="header-middle">My Guestbook(<span
                                id="guestbook-size">{{ entries|length }}</span>) <span id="guestbook-type"
                                                                                       class="{{ sticker.getGuestbookState() }}"><img
                                    src="{{ site.staticContentPath }}/web-gallery/images/groups/status_exclusive.gif"
                                    title="myhabbo.guestbook.unknown.private" alt="myhabbo.guestbook.unknown.private"/></span></span><span
