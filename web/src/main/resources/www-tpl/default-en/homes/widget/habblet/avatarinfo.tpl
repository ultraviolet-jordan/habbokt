<div class="avatar-list-info-container">
    <div class="avatar-info-basic clearfix">
        <div class="avatar-list-info-close-container"><a href="#" class="avatar-list-info-close"
                                                         id="avatar-list-info-close-3"></a></div>
        <div class="avatar-info-image">
            <img src="{{ site.habboImagingPath }}/habbo-imaging/avatarimage?figure={{ avatar.getFigure() }}&size=b&direction=4&head_direction=4&crr=0&gesture=&frame=1"
                 alt="test"/>
        </div>
