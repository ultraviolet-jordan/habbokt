<div class="movable widget TraxPlayerWidget" id="widget-{{ sticker.getId() }}"
    ...
    <div class="w_skin_{{ sticker.getSkin() }}">
        ...
        <div class="widget-body">
            <div class="widget-content">
                ...
                <div id="traxplayer-content" style="text-align: center;"><img
                            src="{{ site.staticContentPath }}/web-gallery/images/traxplayer/player.png"/></div>
                {% else %}
                ...
                <div id="edit-menu-trax-select-temp" style="display:none">
                    <select id="trax-select-options-temp">
                        ...
                        <option value="{{ s.getId() }}"
                                {% if song.getId() == s.getId() %}selected{% endif %}>{{ s.getTitle() }}
                        </option>
                        {% endfor %}</select>
                </div>
                {% endif %}
