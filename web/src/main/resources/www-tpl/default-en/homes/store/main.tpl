            ...
            <ul class="purchase-main-category">
                <li id="maincategory-1-stickers" class="selected-main-category webstore-selected-main">
                    ...
                    <ul class="purchase-subcategory-list" id="main-category-items-1">
                        ...
                        {% if num == 0 %}
                        <li id="subcategory-1-{{ category.getId() }}-stickers" class="subcategory-selected">{% else %}
                        <li id="subcategory-1-{{ category.getId() }}-stickers" class="subcategory">{% endif %}
        ...
        <div id="webstore-preview-container">
            ...
            <div id="webstore-preview">
                ...
                <div id="webstore-preview-price">
                    Price:<br/><b>
                        {% if product.getPrice() > 1 %}{{ product.getPrice() }} credits{% else %}{{ product.getPrice() }
                        } credit{% endif %}
                    </b>
                </div>

                <div id="webstore-preview-purse">
                    {% if playerDetails.credits > 1 %}You have:<br/><b>{{ playerDetails.credits }}
                        credits</b><br/>{% else %}You have:<br/><b>{{ playerDetails.credits }}
                        credit</b><br/>{% endif %}
