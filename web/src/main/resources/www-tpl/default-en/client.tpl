...
<div id="client-topbar" style="display:none">
    ...
    <div class="logo">
        <img src="{{ site.staticContentPath }}/web-gallery/images/popup/popup_topbar_habbologo.gif" alt="" align="middle"/>
    </div>
    <div class="habbocount">
        <div id="habboCountUpdateTarget">
            {{ site.formattedUsersOnline }} members online
        </div>
    ...
    <div class="logout">
        <a href="{{ site.sitePath }}/account/logout?origin=popup" onclick="self.close(); return false;">Close Hotel</a>
    </div>
</div>
<noscript>
    ...
    <div id="clientembed">
        ...
        <noscript>
            <object classid="clsid:166B1BCA-3F9C-11CF-8075-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/director/sw.cab#version=10,0,0,0" id="Theme" width="960" height="540">
                ...
                <embed src="{{ site.loaderDcr }}" bgColor="#000000" width="960" height="540" swRemote="swSaveEnabled='true' swVolume='true' swRestart='false' swPausePlay='false' swFastForward='false' swTitle='Themehotel' swContextMenu='true'" swStretchStyle="stage" swText="" type="application/x-director" pluginspage="http://www.macromedia.com/shockwave/download/" {{ forwardSub }} sw6="client.connection.failed.url={{ site.sitePath }}/clientutils.php?key=connection_failed;external.variables.txt={{ site.loaderVariables }}country={{ preferredCountry }}" sw9="{{ shortcut }}account_id={{ playerDetails.id }}" sw8="use.sso.ticket=1;sso.ticket={{ ssoTicket }}" sw2="connection.info.host={{ site.loaderGameIp }};connection.info.port={{ site.loaderGamePort }}" sw4="site.url={{ site.sitePath }};url.prefix={{ site.sitePath }}" sw3="connection.mus.host={{ site.loaderMusIp }};connection.mus.port={{ site.loaderMusPort }}" sw1="client.allow.cross.domain=1;client.notify.cross.domain=0" sw7="external.texts.txt={{ site.loaderTexts }}" sw5="client.reload.url={{ site.sitePath }}/client.php?x=reauthenticate;client.fatal.error.url={{ site.sitePath }}/clientutils.php?key=error"></embed>
                <noembed>client.pluginerror.message</noembed>
            </object>
        </noscript>
