...
<div id="client-topbar" style="display:none">
    ...
    <div class="logo"><img src="{{ site.staticContentPath }}/web-gallery/images/popup/popup_topbar_habbologo.gif" alt=""
                           align="middle"/></div>
    ...
    <div class="logout"><a href="{{ site.sitePath }}/account/logout?origin=popup" onclick="self.close(); return false;">Close
            Hotel</a></div>
</div>
<noscript>
    <img src="{{ site.sitePath }}/clientlog/nojs" border="0" width="1" height="1" alt=""
    ...
    <div id="clientembed">
        ...
        <noscript>
            <object classid="clsid:166B1BCA-3F9C-11CF-8075-444553540000"
                ...
                <param name="bgColor" value="#000000">
                <param name="sw6"
                       value="client.connection.failed.url={{ site.sitePath }}/clientutils.php?key=connection_failed;external.variables.txt={{ site.loaderVariables }}country={{ preferredCountry }}">
                {{ forward }}
                <param name="sw9" value="{{ shortcut }}account_id={{ playerDetails.id }}">
                <param name="sw8" value="use.sso.ticket=1;sso.ticket={{ ssoTicket }}">
                <param name="sw2"
                       value="connection.info.host={{ site.loaderGameIp }};connection.info.port={{ site.loaderGamePort }}">
                <param name="sw4" value="site.url={{ site.sitePath }};url.prefix={{ site.sitePath }}">
                <param name="sw3"
                       value="connection.mus.host={{ site.loaderMusIp }};connection.mus.port={{ site.loaderMusPort }}">
                <param name="sw1" value="client.allow.cross.domain=1;client.notify.cross.domain=0">
                <param name="sw7" value="external.texts.txt={{ site.loaderTexts }}">
                <param name="sw5"
                       value="client.reload.url={{ site.sitePath }}/client.php?x=reauthenticate;client.fatal.error.url={{ site.sitePath }}/clientutils.php?key=error">
                ...
                <embed src="{{ site.loaderDcr }}" bgColor="#000000" width="960" height="540"
                       ...
                       swStretchStyle="stage" swText="" type="application/x-director"
