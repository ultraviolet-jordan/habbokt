                    ...
                    <div class="habblet-container ">
                        ...
                        <div class="cbb clearfix green">
                            ...
                            <div class="box-content">
                                <p>Register for free by clicking the Create Your Habbo -button below. If you have
                                    already registered, please sign in on the right.</p>
                                <div class="register-button clearfix">
                                    <a href="{{ site.sitePath }}/register"
                                       onclick="HabboClient.closeHabboAndOpenMainWindow(this); return false;">Create
                                        Your Habbo »</a>
                                    <span></span>
                                </div>
                            </div>
                        ...
                        <div class="logincontainer">
                            ...
                            <div class="cbb loginbox clearfix">
                                ...
                                <div class="box-content clearfix" id="login-habblet">
                                    <form action="{{ site.sitePath }}/account/submit" method="post"
                                          class="login-habblet">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <input tabindex="1" type="text" class="login-field" name="username"
                                                       id="login-username" value="" maxlength="48"/>
                                            </li>
                                            ...
                                            <li>
                                                ...
                                                <a href="#" id="login-submit-new-button" class="new-button"
                                                   style="margin-left: 0;display:none"><b
                                                            style="padding-left: 10px; padding-right: 7px; width: 55px">Login</b><i></i></a>
                                            </li>
                                            ...
                                            <li id="register-link" class="no-label">
                                                <a href="{{ site.sitePath }}/register" class="login-register-link"
                                                   onclick="HabboClient.closeHabboAndOpenMainWindow(this); return false;"><span>Register for free</span></a>
                                            </li>
                                            <li class="no-label">
                                                <a href="{{ site.sitePath }}/account/password/forgot"
                                                   id="forgot-password"><span>Forgot your password?</span></a>
                                            </li>
                                        </ul>
                                        <div id="remember-me-notification" class="bottom-bubble" style="display:none;">
                                            ...
                                            <div class="bottom-bubble-c">
                                                By selecting this you will stay logged in to Habbo, until you &quot;Log
                                                out&quot;.
                                            </div>
