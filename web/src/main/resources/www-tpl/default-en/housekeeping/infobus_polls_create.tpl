...
<form class="table-responsive col-md-4" method="post">
    ...
    <p>
        <button type="button" class="btn btn-success" onclick="cloneAnswer()">Add answer</button>
    </p>
    <p>
        <button type="button" class="btn btn-primary" onclick="removeLatestAnswer()">Remove answer</button>
    </p>
