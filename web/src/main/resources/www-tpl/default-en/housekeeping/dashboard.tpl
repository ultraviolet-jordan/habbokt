...
<div style="margin:10px">
    ...
    <a href="{{ site.sitePath }}/{{ site.housekeepingPath }}?page={{ ourNextPage }}{{ zeroCoinsValue }}&sort={{ sortBy }}">
    ...
    <a href="{{ site.sitePath }}/{{ site.housekeepingPath }}">
        <button type="button" class="btn btn-warning">View players with coins</button>
    </a>
    {% else %}
    <a href="{{ site.sitePath }}/{{ site.housekeepingPath }}?zerocoins">
        <button type="button" class="btn btn-warning">View players without coins</button>
    </a>
    {% endif %}
</div>
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><a href="{{ site.sitePath }}/{{ site.housekeepingPath }}/api/ban?username={{ player.name }}">
                    <button type="button" class="btn btn-success">Permanently Ban User</button>
                </a></td>
        </tr>
        {% set num = num + 1 %}
        {% endfor %}
