<form action="#" method="post" id="topic-settings-form">
    ...
    <div id="topic-type-area">
        ...
        <div class="topic-type-input">
            ...
            <br/>
            <input type="radio" name="topic_sticky" id="topic_normal" value="0" {% if topic.isStickied() == false %}checked="true" {% endif %}/> Normal
        </div>
        <div class="topic-type-input">
            <input type="radio" name="topic_type" id="topic_closed" value="1" {% if topic.isOpen == false %}checked="true" {% endif %}/> Closed
            <br/>
            <input type="radio" name="topic_sticky" id="topic_sticky" value="1" {% if topic.isStickied() %}checked="true" {% endif %}/> Sticky thread
        </div>
    </div>
