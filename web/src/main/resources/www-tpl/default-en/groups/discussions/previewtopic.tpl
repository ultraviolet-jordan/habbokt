<table border="0" cellpadding="0" cellspacing="0" width="100%" class="group-postlist-list" id="group-postlist-list">
    <tr class="post-list-index-preview">
        <td class="post-list-row-container">
            <a href="{{ site.sitePath }}/home/{{ playerDetails.id }}/id"
               class="post-list-creator-link post-list-creator-info">{{ playerDetails.getName() }}</a>
            ...
            <div class="clearfix">
                <div class="post-list-creator-avatar">
                    <img src="{{ site.habboImagingPath }}/habbo-imaging/avatarimage?figure={{ playerDetails.figure }}&size=b&direction=2&head_direction=2&crr=0&gesture=&frame=1"
                         alt=""/>
                </div>
                {% if hasGroup %}
                <div class="post-list-group-badge">
                    <a href="{{ site.sitePath }}/groups/{{ groupId }}/id"><img
                                src="{{ site.habboImagingPath }}/habbo-imaging/badge/{{ groupBadge }}.gif"/></a></div>
                {% endif %}
                {% if hasBadge %}
        ...
        <td class="post-list-message" valign="top" colspan="2">
            ...
            <div>
                <div id="discussion-captcha-preview"></div>
                <div class="button-area">
                    <a id="topic-form-cancel-preview" class="new-button red-button cancel-icon"
