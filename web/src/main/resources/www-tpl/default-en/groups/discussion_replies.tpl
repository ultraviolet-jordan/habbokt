...
<div class="postlist-header clearfix">
    ...
    <div class="page-num-list">
        ...
        {% if previousPage5 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ previousPage5 }}">{{ previousPage5 }
            }</a>
        {% endif %}

        {% if previousPage4 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ previousPage4 }}">{{ previousPage4 }
            }</a>
        {% endif %}

        {% if previousPage3 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ previousPage3 }}">{{ previousPage3 }
            }</a>
        {% endif %}

        {% if previousPage2 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ previousPage2 }}">{{ previousPage2 }
            }</a>
        {% endif %}

        {% if previousPage1 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ previousPage1 }}">{{ previousPage1 }
            }</a>
        {% endif %}
        {{ currentPage }}
        {% if nextPage1 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ nextPage1 }}">{{ nextPage1 }
            }</a>
        {% endif %}

        {% if nextPage2 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ nextPage2 }}">{{ nextPage2 }
            }</a>
        {% endif %}

        {% if nextPage3 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ nextPage3 }}">{{ nextPage3 }
            }</a>
        {% endif %}

        {% if nextPage4 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ nextPage4 }}">{{ nextPage4 }
            }</a>
        {% endif %}

        {% if nextPage5 != -1 %}
        <a href="{{ group.generateClickLink() }}/discussions/{{ discussionTopic.getId() }}/id/page/{{ nextPage5 }}">{{ nextPage5 }
            }</a>
        {% endif %}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="group-postlist-list" id="group-postlist-list">
    ...
    <tr class="postlist-leaderboard">
        <td colspan="3">
            <div class="habblet ad-forum-leaderboard">
