...
<div class="gift-img">
    {% if newbieNextGift == 1 %}
    <img src="{{ site.staticContentPath }}/web-gallery/v2/images/welcome/newbie_furni/noob_stool_{{ newbieRoomLayout }}.png"
         alt="My first starter stool">
    {% elseif newbieNextGift == 2 %}
    <img src="{{ site.staticContentPath }}/web-gallery/v2/images/welcome/newbie_furni/noob_plant.png"
         alt="My first plant">
    {% endif %}
</div>
<div class="gift-content-container">
    ...
    <p class="last">
        <a class="new-button green-button"
           href="{{ site.sitePath }}/client?forwardId=2&roomId={{ playerDetails.getSelectedRoomId() }}" target="client"
           onclick="HabboClient.roomForward(this, '{{ playerDetails.getSelectedRoomId() }}', 'private'); return false;"><b>Go
                to your room &gt;&gt;</b><i></i></a>
    </p>
    <br style="clear: both"/>
</div>
...
<p class="aftergift-img">
    <img src="{{ site.staticContentPath }}/web-gallery/v2/images/giftqueue/aftergifts.png" alt="" width="289"
         height="63"/>
</p>
<p class="last">
    <a class="new-button green-button"
