                        ...
                        <div class="box-content">
                            <div id="settingsNavigation">
                                <ul>
                                    ...
                                    <li><a href="{{ site.sitePath }}/profile/verify">Email Changing & Verification</a>
                                        {% endif %}
                                    </li>
                                    <li><a href="{{ site.sitePath }}/profile?tab=4">My Password</a>
                                    </li>
                                    <li class="selected">Friend Management
                                    </li>
                        ...
                        <div id="friend-management-container" class="box-content">
                            ...
                            <div id="category-view" class="clearfix">
                                ...
                                <div id="category-list">
                                    ...
                                    <div class="category-default category-item selected-category" id="category-item-0">
                                        Friends
                                    </div>
