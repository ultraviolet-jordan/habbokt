...
<div class="cbb habboclub-tryout">
    ...
    <div class="box-content">
        ...
        <p class="habboclub-header">{{ site.siteName }} Club is our VIP members-only club: absolutely no riff-raff
            admitted! Members enjoy a wide range of benefits, including exclusive clothes, free gifts and an extended
            Friend List.</p>
