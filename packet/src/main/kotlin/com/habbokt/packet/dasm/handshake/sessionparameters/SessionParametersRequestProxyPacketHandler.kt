 ...
 */
@Singleton
class SessionParametersRequestProxyPacketHandler : ProxyPacketHandler<SessionParametersRequestPacket, SessionParametersRequestProxyPacket>(
    handler = {
        ...
        SessionParametersRequestProxyPacket(sessionParameters)
    }
)